    ...
    <>
          ...
          <div className="p-3 sm:p-3.5">
            ...
            <div className="space-y-1.5 mb-3">
              ...
              <div className="flex justify-between items-center">
                ...
                <span className="text-white font-semibold text-sm">
                  {room.availability.nextAvailability}
                </span>
              </div>
                    ...
                    <div key={idx} className="space-y-0.5">
                      <div className="flex justify-between items-start">
                        <div className="flex-1">
                          <span
                            className={`text-sm ${isMainPrice ? "text-gray-300 font-medium" : "text-gray-400"}`}
                          >
                            {price.type}
                            {!price.mandatory && (
                        ...
                        <span
                          className={`font-semibold text-sm whitespace-nowrap ml-2 ${isMainPrice ? "text-orange-500 font-bold text-base" : "text-white"}`}
                        >
      ...
      <InterestDialog
        ...
        propertyDetails={[
          ...
          {
            label: "Monthly Rent",
            value: `₹${room.pricing.find((p) => p.type === "Monthly Rent")?.amount.toLocaleString()}`,
            className: "text-orange-400",
          },
          {
            label: "Availability",
            value: `${room.availability.availableBeds}/${room.availability.totalBeds} beds`,
              ...
              <div className="grid grid-cols-2 gap-3 text-sm">
                ...
                <div>
                  ...
                  <p className="text-green-400 font-medium">
                    ...
                    {room.availability.totalBeds} beds
                  </p>
                </div>
              </div>
            </div>
