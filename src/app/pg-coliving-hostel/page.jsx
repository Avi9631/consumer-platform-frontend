...
import { searchNearbyPgHostels } from "@/lib/services/pgHostelService";
...
export default function PropertySearchPage() {
  ...
  // Search PG/Hostel listings based on location and filters
  const searchProperties = async (
    ...
    try {
      ...
      const result = await searchNearbyPgHostels({
